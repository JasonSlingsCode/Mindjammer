...
/*
Aspects: Blazing Surface of Molten Metal; Crushing Fiery Hellhole.
Stellar Body: Any star.
Age: Any.
Orbit: Extreme Inner to Inner H-Zone.
Size: Small to Large Standard.
Density: Standard to Dense.
Gravity: Low to High.
Day Length: Tidal Lock to Extremely Rapid.
Atmospheric Pressure: Standard to Hazardous.
Temperature: Inferno or higher.
Liquid: Any.
Seasonality: Low or lower.
Biosphere: Parallel.
Habitability: Deadly.
Resources: Plentiful: carbon dioxide, molten metals, nitrogen, sulphuric acid.
*/
...
public class Inferno : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        TheBasePlanetarySystem.Aspects.Add("Blazing Surface of Molten Metal");
        TheBasePlanetarySystem.Aspects.Add("Crushing Fiery Hellhole");
        
        // Add Description
        TheBasePlanetarySystem.PlanetaryDescription = "With terrific atmospheric pressures and / or proximity to a system primary leading to searing temperatures of 750K and higher, inferno worlds have no water, although oceans of molten metals and magma are possible.";
