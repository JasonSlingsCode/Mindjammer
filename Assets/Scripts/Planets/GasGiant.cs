...
/*
Aspects: Gas Giant Mines; Massive Jovian World.
Stellar Body: Any.
...
Density: Very Low.
Gravity: High.
Day Length: Any, but slower closer to primary, including tidal lock.
...
public class GasGiant : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        TheBasePlanetarySystem.Aspects.Add("Gas Giant Mines");
        TheBasePlanetarySystem.Aspects.Add("Massive Jovian World");
        
        // Add Description
        TheBasePlanetarySystem.PlanetaryDescription = "A large planet of at least 55 Old Earth masses, with an atmosphere of almost entirely hydrogen and some helium. Gas giants are usually inhospitable to humans, but may have exotic biospheres. They often have many satellites.";
