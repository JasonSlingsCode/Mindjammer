...
/*
Aspects: Huge Earth-like World With Crushing Gravity; Small Gas Planet.
Stellar Body: Any F- to M-class main sequence star.
Age: Very Young or older.
Orbit: Any.
Size: Large Standard.
Density: Very Low to High Standard.
Gravity: Very Low to High.
Day Length: Any.
Atmospheric Pressure: Low to High.
Temperature: Frigid to Furnace.
Liquid: Any.
Seasonality: Any.
Biosphere: Any.
Habitability: Any.
...
public class SuperEarth : MonoBehaviour
{
    ...
    private int SurfaceTemperatureMaximum = 3;
    ...
    void Start()
    {
        ...
        TheBasePlanetarySystem.Aspects.Add("Huge Earth-like World With Crushing Gravity");
        TheBasePlanetarySystem.Aspects.Add("Small Gas Planet");
        
        // Add Description
        TheBasePlanetarySystem.PlanetaryDescription = "A terrestrial planet or “gas dwarf” from 2 to 10 Old Earth masses. Some super earths may be garden worlds; others may be “mini-Neptunes”.";
