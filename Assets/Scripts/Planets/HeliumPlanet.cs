...
/*
Aspects: Hazardous Orbit; Helium Harvesters; Remnant of a Dead Star.
Stellar Body: White Dwarf (former binary); or none.
Age: Very Young to Young.
Orbit: Any.
Size: Giant.
Density: Very Low.
Gravity: High.
Day Length: Any, but likely slower.
Atmospheric Pressure: Standard to Hazardous.
Temperature: Any.
Liquid: n/a (helium rain).
Seasonality: Any.
Biosphere: Parallel, Exotic.
Habitability: Usually Deadly.
Resources: Plentiful: helium.
*/

public class HeliumPlanet : MonoBehaviour
{
    ...
    private int PlanetaryGravityMinimum = 2;
    ...
    void Start()
    {
        ...
        TheBasePlanetarySystem.Aspects.Add("Hazardous Orbit");
        TheBasePlanetarySystem.Aspects.Add("Helium Harvesters");
        TheBasePlanetarySystem.Aspects.Add("Remnant of a Dead Star");
        
        // Add Description
        TheBasePlanetarySystem.PlanetaryDescription = "A gas giant consisting of helium instead of hydrogen which forms from a low mass white dwarf star, which has undergone major mass loss (perhaps from a binary companion) reducing it to planetary mass.";
