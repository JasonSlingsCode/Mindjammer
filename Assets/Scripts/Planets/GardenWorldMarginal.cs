...
public class GardenWorldMarginal : MonoBehaviour
{
    ...
    private int PlanetaryDayLengthMaximum = 7;
    ...
    void Start()
    {
        ...
        TheBasePlanetarySystem.Aspects.Add("Harsh High-Grav World With Barely Breathable Atmosphere");
        TheBasePlanetarySystem.Aspects.Add("Violent Swings From Burning to Freezing");
        
        // Add Description
        TheBasePlanetarySystem.PlanetaryDescription = "Marginal garden worlds include aqueous worlds with extreme orbits, oceanworlds, garden worlds with very high or low gravity, trace or tainted atmospheres, no water, and so on. Some otherwise hospitable garden worlds are made marginal by their highly eccentric orbits, often taking them out of the habitable zone.";
