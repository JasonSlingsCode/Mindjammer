...
/*
Example Aspects: Do You Have Instrumentality Business?
Endless Comings and Goings; R&R and the Novelty
Trade; Short-Term Shipping Contract.
Designation: Commonality Member.
Population: Low Standard to High.
Government: Commonality-controlled.
Societal Dev: Sentience Coordinated Collective.
Openness: Guarded.
Control: Restricted.
Trade: High Moderate or lower.
Tech: T9 or lower.
Starport: A-class or higher.
Mindscape: Systemwide or lower.
*/

public class InstrumentalityHub : MonoBehaviour
{
    ...
    private int TradeIndexMaximum = 1;
    ...
    void Start()
    {
        ...
        TheBaseCivilization.Aspects.Add("Do You Have Instrumentality Business?");
        TheBaseCivilization.Aspects.Add("Endless Comings and Goings");
        TheBaseCivilization.Aspects.Add("R&R and the Novelty Trade");
        TheBaseCivilization.Aspects.Add("Short-Term Shipping Contract");
        
        // Add Description
        TheBaseCivilization.CivilizationDescription = "An organisational centre for an instrumentality, governed by it rather than the local Pansectorate. AFI and Space Force hubs are also often depots (page 348).";
