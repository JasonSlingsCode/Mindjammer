...
/*
Example Aspects: A Market for Countless Worlds;
Mother Ship Monument; News and Information; Proud and
Independent.
Designation: Commonality Autonomous or lower.
Population: High or higher.
Government: Representative to Oligarchy.
Societal Dev: Taxation or higher.
Openness: Any.
Control: Any.
Trade: High Moderate or higher.
Tech: T7 or higher.
Starport: D-class or higher.
Mindscape: None; or Local Node or lower.
*/

public class InterstellarHub : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        TheBaseCivilization.Aspects.Add("A Market for Countless Worlds");
        TheBaseCivilization.Aspects.Add("Mother Ship Monument");
        TheBaseCivilization.Aspects.Add("News and Information");
        TheBaseCivilization.Aspects.Add("Proud and Independent");
        
        // Add Description
        TheBaseCivilization.CivilizationDescription = "The “main world” of an interstellar civilisation, usually the original lost colony founded during the Great Diaspora.";
