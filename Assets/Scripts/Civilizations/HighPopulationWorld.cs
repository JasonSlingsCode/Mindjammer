...
/*
Example Aspects: Distractions and Diversions; Explosive
Neurotic Safety Valves; Mass Markets; Tides of Psychohistory.
Designation: Any.
Population: High or higher.
Government: Any.
...
public class HighPopulationWorld : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        TheBaseCivilization.Aspects.Add("Distractions and Diversions");
        TheBaseCivilization.Aspects.Add("Explosive Neurotic Safety Valves");
        TheBaseCivilization.Aspects.Add("Mass Markets");
        TheBaseCivilization.Aspects.Add("Tides of Psychohistory");
        
        // Add Description
        TheBaseCivilization.CivilizationDescription = "The Core Worlds have many stable high-population worlds; on the Fringe, they may be suffering from rampant overpopulation. There’s a tendency to view high populations as faceless homogenous masses, exacerbating difficulties.";
