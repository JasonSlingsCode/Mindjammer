...
/*
Example Aspects: Food and Luxuries; Hard-Nosed Exile;
Here at My Own Command; High Security Transport.
Designation: Commonality Quarantine.
...
Mindscape: Local Node.
*/

public class PrisonPlanet : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        TheBaseCivilization.Aspects.Add("Food and Luxuries");
        TheBaseCivilization.Aspects.Add("Hard-Nosed Exile");
        TheBaseCivilization.Aspects.Add("Here at My Own Command");
        TheBaseCivilization.Aspects.Add("High Security Transport");
        
        // Add Description
        TheBaseCivilization.CivilizationDescription = "A “feature” of the Core Worlds, prison planets are usually marginal garden worlds (page 333) where unwanted or dangerous elements of the population can be housed. Given the Commonality’s re-education facilities, sentence to a prison planet is almost always voluntary.";
