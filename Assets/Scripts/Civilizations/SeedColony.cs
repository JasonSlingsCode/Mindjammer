...
/*
Example Aspects: A Few Little Luxuries; An Opportunity
to Begin Again! Looking for a Niche; We Happy Few.
Designation: Commonality Autonomous or higher.
Population: Low or lower.
Government: Corporacy-controlled or higher.
...
Mindscape: Local Node or higher.
*/

public class SeedColony : MonoBehaviour
{
    ...
    private int MindscapeMinimum = -3;
    ...
    void Start()
    {
        ...
        TheBaseCivilization.Aspects.Add("A Few Little Luxuries");
        TheBaseCivilization.Aspects.Add("An Opportunity to Begin Again!");
        TheBaseCivilization.Aspects.Add("Looking for a Niche");
        TheBaseCivilization.Aspects.Add("We Happy Few");
        
        // Add Description
        TheBaseCivilization.CivilizationDescription = "A seed colony is a startup colonisation effort on a world exploitable without extensive terraforming or genurgy. Corporacies establish seed colonies, as may instrumentalities for strategic reasons, usually out on the Fringe.";
