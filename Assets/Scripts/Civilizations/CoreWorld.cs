...
/*
Example Aspects: Byzantine and Unfathomable;
Cultural Artifacts; Jaded Appetites; Overwhelmed by Intimidating
Antiquity.
...
public class CoreWorld : MonoBehaviour
{
    ...
    private int CivOpennessMinimum = -1;
    ...
    void Start()
    {
        ...
        TheBaseCivilization.Aspects.Add("Byzantine and Unfathomable");
        TheBaseCivilization.Aspects.Add("Cultural Artifacts");
        TheBaseCivilization.Aspects.Add("Jaded Appetites");
        TheBaseCivilization.Aspects.Add("Overwhelmed by Intimidating Antiquity");
        
        // Add Description
        TheBaseCivilization.CivilizationDescription = "The byzantine and sophisticated civilisations of the Commonality Core are part of the Core Worlds culture. They’re usually highly specialised and stratified.";
